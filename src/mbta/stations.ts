    ...
    Red: {
        ...
        stations: [
            ...
            },
            {
                stop_name: 'Ashmont',
                branches: ['A'],
                station: 'place-asmnl-A',
                order: 105,
                stops: {
                    '0': ['70094'],
                    '1': ['70093'],
                },
                transfers: ['place-asmnl-M'],
                accessible: true,
                enclosed_bike_parking: true,
                pedal_park: true,
                terminus: true,
            },
            {
                stop_name: 'Ashmont',
                branches: ['M'],
                station: 'place-asmnl-M',
                order: 105,
                stops: {
                    '0': ['70107'],
                    '1': ['70106'],
                },
                transfers: ['place-asmnl-A'],
                accessible: true,
                enclosed_bike_parking: true,
                pedal_park: true,
                terminus: true,
